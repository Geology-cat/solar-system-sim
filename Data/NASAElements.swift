...
///
/// 元期: J2000.0 (= JD 2451545.0)
/// 角度単位: degrees / レート単位: degrees per Julian century
/// 木星〜冥王星には平均近点角に対する補正項 b, c, s, f を併用する
struct NASAElements {
    static let planets: [CelestialBody] = [
        // 水星
        CelestialBody(name: "水星", color: .gray, radiusMultiplier: 0.38, elements: OrbitalElements(
        ...
        // 金星
        CelestialBody(name: "金星", color: .orange, radiusMultiplier: 0.95, elements: OrbitalElements(
        ...
        // 地球 (実際は地球-月の重心 EMB を使用、地表上の観測でも誤差は地心-月心距離以下)
        CelestialBody(name: "地球", color: .blue, radiusMultiplier: 1.0, elements: OrbitalElements(
        ...
        // 火星
        CelestialBody(name: "火星", color: .red, radiusMultiplier: 0.53, elements: OrbitalElements(
        ...
        // 木星 (補正項 b, c, s, f が必要)
        CelestialBody(name: "木星", color: .brown, radiusMultiplier: 11.2, elements: OrbitalElements(
        ...
        // 土星
        CelestialBody(name: "土星", color: .yellow, radiusMultiplier: 9.45, elements: OrbitalElements(
        ...
        // 天王星
        CelestialBody(name: "天王星", color: .cyan, radiusMultiplier: 4.0, elements: OrbitalElements(
        ...
        // 海王星
        CelestialBody(name: "海王星", color: .blue, radiusMultiplier: 3.88, elements: OrbitalElements(
        ...
        // 冥王星
        CelestialBody(name: "冥王星", color: .purple, radiusMultiplier: 0.18, elements: OrbitalElements(
